		...
		<div class="container">
			...
			<div class="w3ls_logo_products_left1">
				<ul class="phone_email" >
					<li style="color:#fff;"><i class="fa fa-phone" style="color:#fff;" aria-hidden="true"></i>(+91)7483538785</li>
					<li style="color:#fff;"><i class="fa fa-envelope-o" style="color:#fff;" aria-hidden="true"></i><a href="mailto:vinayhn2019.gmail.com" style="color:#fff;">info@balas.co.in</a></li>
				</ul>
			</div>
			<div class="clearfix"> </div>
		</div>
